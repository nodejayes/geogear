// Definition taken from Postgres v11 with PostGIS 2.5.2
/*
    select json_object(array_agg(q.key), array_agg(q.value)) from (
        select auth_name || ':' || auth_srid as key, proj4text as value from spatial_ref_sys
    ) q;
 */
export const EPSG = {
    ...
    "EPSG:7677": "+proj=geocent +a=6378136 +b=6356751.361745712 +units=m +no_defs ",
    ...
    "EPSG:8065": "+proj=omerc +lat_0=32.25 +lonc=-111.4 +alpha=45 +k=1.00011 +x_0=48768 +y_0=243840 +gamma=45 +ellps=GRS80 +units=ft +no_defs ",
    ...
    "EPSG:27224": "+proj=tmerc +lat_0=-43.59063758333333 +lon_0=172.7271935833333 +k=1 +x_0=300000 +y_0=700000 +datum=nzgd49 +units=m +towgs84=59.47,-5.04,187.44,0.47,-0.1,1.024,-4.5993 +nadgrids=nzgd2kgrid0005.gsb +no_defs ",
    ...
    "EPSG:27230": "+proj=tmerc +lat_0=-45.81619661111111 +lon_0=170.6285951666667 +k=1 +x_0=300000 +y_0=700000 +datum=nzgd49 +units=m +towgs84=59.47,-5.04,187.44,0.47,-0.1,1.024,-4.5993 +nadgrids=nzgd2kgrid0005.gsb +no_defs ",
    ...
    "EPSG:28992": "+proj=sterea +lat_0=52.15616055555555 +lon_0=5.38763888888889 +k=0.9999079 +x_0=155000 +y_0=463000 +ellps=bessel +towgs84=565.2369,50.0087,465.658,-0.406857,0.350733,-1.87035,4.0812 +units=m +no_defs ",
    ...
    "EPSG:7679": "+proj=geocent +a=6378136 +b=6356751.361745712 +units=m +no_defs ",
    "EPSG:7681": "+proj=geocent +a=6378136.5 +b=6356751.757955603 +units=m +no_defs ",
